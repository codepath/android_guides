...
Now open [Google API Console](https://cloud.google.com/console), create and select a project, select "APIs & Auth" on left side, select **Google Maps Android API v2** and enable the Maps API via the toggle switch.
