...
See the instructions to [[Genymotion-2.0-Emulators-with-Google-App-support]].  It includes directions for setting Google Play Services and GPS too.  You will need to setup both in order to setup the map demo in the next section.
