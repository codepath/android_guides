...
* Just because a program runs, doesn’t mean it’s doing what you expected.  This class of issues are known as runtime errors. This is contrast to compile-time errors which prevent an app from running and are often easier to catch.  
