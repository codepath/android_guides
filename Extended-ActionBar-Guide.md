...
```
**Note** that if you are trying to build for a different version other than SDK 21, use `com.android.support:appcompat-v7:22.2.0`.  There are different themes in SDK 21, so you are likely to have compile errors.  For more context, see this [Stack Overflow](http://stackoverflow.com/questions/26457096/appcompat-v7-r21-returning-error-in-values-xml) discussion.
