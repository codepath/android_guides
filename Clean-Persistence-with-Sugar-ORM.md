...
It's also available on Maven central. Installing with gradle is as simple as adding `implementation 'com.github.satyan:sugar:1.3'` to your `build.gradle` file.
