...
These attributes can be defined in each theme later and then applied to views on the page by adding a `style` property indicating the attribute to apply.  We will implement this part in [[step 6|Developing-Custom-Themes#6-#6-create-themes-xml-file]].
