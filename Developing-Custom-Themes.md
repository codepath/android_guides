...
In addition, note how we implement the [custom attributes in the theme](https://github.com/codepath/android_guides/wiki/Developing-Custom-Themes#3-custom-attributes), such as `pageBackground`, `textSubheader`, etc. in the theme.
