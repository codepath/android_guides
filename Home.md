...
**Need Help?** Please join this [gitter](https://gitter.im/thecodepath/public) real-time chat or the [google groups](https://groups.google.com/forum/#!forum/codepath-android-guides) for these guides where you can post related questions.
...
* [[Google Maps Setup Guide|Google Maps Fragment Guide]] (and [Setup Genymotion](https://github.com/thecodepath/android_guides/wiki/Google-Maps-Fragment-Guide#genymotion))
