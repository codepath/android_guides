Welcome to the open-source Codepath Android Guides! Our goal is to become the **central crowd-sourced repository** for complete and up-to-date Android content and tutorials. We have guides for everyone beginner, intermediate or advanced. Want to learn [[about testing|Android Unit and Integration Testing]] or how to [[build flexible user interfaces for multiple devices|[[Flexible User Interfaces]]? We got you covered. 
