...
**Note:** To skip to changing the behavior of the task stack, jump right to the [Usage](https://github.com/thecodepath/android_guides/wiki/Navigation-and-Task-Stacks#usage) section of this document.
